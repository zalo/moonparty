...
type Config struct {
	...
	// UseLimelight enables the moonlight-common-go backend for streaming
	// This provides proper Moonlight protocol support with FEC, depacketization, and input handling
